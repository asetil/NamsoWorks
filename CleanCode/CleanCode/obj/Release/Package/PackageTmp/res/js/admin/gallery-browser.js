; (function ($) {
    ...
    var fileOperations = {
        ...
        copyFileAddress: function () {
            ...
            var fileName = $(this).parents(".file-item:eq(0)").data("path");
            var copyValue = "<img src='" + siteUrl + directory + "/" + fileName + "' alt='" + fileName + "' class='img-responsive'/>";
        ...
        loadPath: function (path) {
            ...
            $.post('/Gallery/LoadPath', { path: path }, function (result) {
                ...
                if (result.success == 1) {
                    ...
                    var message="<div class='alert alert-danger'>"+result.message+"</div>";
                    $(".gallery-placeholder").html(message);
                }
            });
            return false;
        },
