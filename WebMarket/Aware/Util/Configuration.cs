...
namespace Aware.Util
{
    public static class Config
    {
        ...
        public static string ElasticIndex { get; private set; }
        public static string ElasticUrl { get; private set; }
        ...
        private static void Initialize()
        {
            ...
            ElasticIndex = Value("ElasticIndex");
            ElasticUrl = Value("ElasticUrl");
