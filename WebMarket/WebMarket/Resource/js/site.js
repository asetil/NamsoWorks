...
(function ($) {
    var handlers = {
        ...
        checkUserNotification: function () {
            var hasNotification = $("#HasNotification").val();
            if (hasNotification == 1) {
                $.post("/Helper/CheckNotification", {}, function (response) {
                    if (response.success) {
                        $("#userNotificationModal .notification-content").html(response.notification.Content);
        ...
        ready: function () {
            ...
            setTimeout(function () { handlers.checkUserNotification(); }, 3600);

            var url = "https://apis.garanti.com.tr/auth/oauth/v2/token?client_id=l7xxbef3f96a3f60401099bef251b89e9844&client_secret=95e5cd1b699b4b0d8ce6ec993ae2c9de&grant_type=client_credentials&redirect_uri=http://site.aware.com/home/demo";
