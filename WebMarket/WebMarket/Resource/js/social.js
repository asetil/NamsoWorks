; (function ($) {
    ...
    var handlers = {
        ...
        processGoogleLogin: function () {
            $.post("/Social/GetGoogleLoginUrl", {}, function (data) {
                if (data.success == 1) {
                    document.location = data.url;
                }
                else {
    ...
    var eventMetaData = [
        ...
        { selector: elem.btnGoogleLogin, container: document, event: "click", handler: handlers.processGoogleLogin, data: {} },
